...
const data: CardType[] = [
  ...
  { name: "The Lucy Lamp", price: "£399", size: "single", image: "/parent.png" },
];
const NewCeramics = ({ heading }: { heading?: string }) => {
  return (
    <div className="w-full text-blue-900 flex flex-col gap-6 my-16 mmd:px-10 px-5">
      ...
      <div className="w-full flex justify-center">
        <Link href="/products">
          <button className="bg-gray-300 h-12 w-36 capitalize text-sm">
            view collection
          </button>
        </Link>
      </div>
