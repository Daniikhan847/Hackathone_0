...
const SearchBar = () => {
  return (
      <span className="sm:w-[500px] xs:w-4/5 w-full sm:h-12 h-10 relative flex mt-5">
        <input
          type="text"
          className="h-full w-full focus:outline-none px-5 bg-gray-300 max-sm: text-sm"
          placeholder="your@email.com"
        />
        <button className="absolute top-0 right-0 h-full xs:w-24 max-xs:px-3 text-white capitalize bg-blue-950 sm:text-sm text-xs">
          sign up
        </button>
      </span>
  );
