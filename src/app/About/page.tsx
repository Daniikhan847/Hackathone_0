  ...
  return (
    <div>
      <section className="sm:h-48 w-full flex max-sm:flex-col max-sm:gap-10 max-sm:pt-10 items-center justify-between md:px-24 px-5">
        <h1 className="sm:text-2xl text-xl font-clash text-blue-950 sm:w-[500px] max-xxs:px-3">
          A brand built on the love of craftmanship, quality and
          outstanding customer service
        </h1>
        <Link href="/products">
        <button className="bg-gray-100 h-12 sm:w-36 w-full sm:text-sm text-xs">
          View our products
        </button>
        </Link>
      </section>
...
const TextSection = () => {
  return (
    <section className="md:h-[450px] max-md:gap-10 md:w-1/2 w-full bg-blue-950 text-white sm:py-12 py-8 flex flex-col justify-between sm:px-10 px-5">
      ...
      <Link href="/products">
        <button className="bg-blue-950 h-12 md:w-36 w-full capitalize text-sm">
        view collection
      </button>
      </Link>
    </section>
